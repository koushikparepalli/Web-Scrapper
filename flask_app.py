...
def index():
    if request.method == 'POST':
        ...
        try:
            ...
            db = dbConn['crawlerDB'] # connecting to the Mongodb database called crawlerDB
            ...
            if reviews.count() > 0: # if there is a collection with searched keyword and it has records in it
                ...
                # Inserting scraped data from Flipkart into MongoDB
                ...
                for commentbox in commentboxes:
                    ...
                    x = table.insert_one(mydict) #insertig the dictionary containing the rview comments to the collection created
